    ...
    <header className="nav" aria-label="Top navigation">
      ...
      <Link className="brand" to="/">
        <span className="logo" aria-hidden="true">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
            ...
            />
            <path
              d="M12 3.5 4.5 6.2v5.9c0 4.7 3.2 8 7.5 8.9 4.3-.9 7.5-4.2 7.5-8.9V6.2L12 3.5Z"
              stroke="currentColor"
              strokeWidth="1.5"
              opacity="0.82"
            />
        ...
        <span>
          <strong>Factify</strong>
          <span className="helper">Fake News Detection</span>
        </span>
      </Link>
      ...
      <div className="nav-actions">
        ...
        {isLoggedIn && bookmarkCount > 0 && (
          <div className="bookmark-count" title="Saved bookmarks">
            {bookmarkCount}
          </div>
        )}
          ...
          <div className="menu-list">
            ...
            >
              ...
              <div className="menu-item-text">
                ...
                <span>View detection insights</span>
              </div>
            </Link>
            ...
            >
              ...
              <div className="menu-item-text">
                ...
                <span>View your previous activity</span>
              </div>
            </Link>
            ...
            >
              <div className="menu-icon">
                <svg
                  ...
                  viewBox="0 0 16 16"
                >
                  <path d="M2 4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v11.5a.5.5 0 0 1-.777.416L8 12.101l-5.223 3.815A.5.5 0 0 1 2 15.5V4z" />
                  <path d="M5 3.5V14.134l3-2.188 3 2.188V3.5H5z" />
                </svg>
              </div>
              <div className="menu-item-text">
                <strong>Bookmarks</strong>
                <span>Saved credibility reports</span>
              </div>
            </Link>
